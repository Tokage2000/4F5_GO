...
public class MonClientEn extends Application {
	
	static {
		Initialisateur.initialiser();
		J.appel(MonClientEn.class);
	}
	...
	private Scene instancierControleurAccueil() {
		...
		chargeur = new ChargeurDeVue<VueAccueil>(CHEMIN_PRINCIPAL_FXML, CHEMIN_PARTIE_LOCALE_CSS, CHEMIN_CHAINES_ANGLAIS);
